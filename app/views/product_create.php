<!DOCTYPE html>
<html lang="en">
<head><meta charset="UTF-8"><meta name="viewport" content="width=device-width, initial-scale=1.0"><title>Add Product</title>
<style>
    body {
        margin: 0;
        padding: 2rem;
        ...
        <div class="panel">
            ...
            <form action="<?= site_url('products/create'); ?>" method="post">
                ...
                <div class="field">
                    ...
                    <input id="quantity" type="number" name="quantity" min="0" step="1" required>
                </div>
